...
<div class="col-md-12" align="right">
    <a href="{{ route('recruitmenttype.create') }}" class="btn btn-primary btn-sm" style="margin-bottom: 11px;">Add Recruitment Type</a>
</div> 
         ...
         <td>
            <div class="dropdown show pull-right">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" x-placement="bottom-start" style="position: absolute; transform: translate3d(-5px, 38px, 0px); top: 0px; left: 0px; will-change: transform;"> 
                     ...
                     <a class="dropdown-item" href="{{ route('recruitmenttype.edit',$recruitmentType->id) }}">Modify</a> 
                        

                     <form method="post" action="{{ route('recruitmenttype.destroy',$recruitmentType->id) }}">
