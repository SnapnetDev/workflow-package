  <div class="col-lg-12 sidebar" style="padding: 0;">
    ...
    z-index: 964;
">
                <h4 style="text-decoration: underline;">Filter Applicants Pool</h4>
                <ul class="cat-list">
<!-- skills -->
          <div class="row">
            ...
            <div class="form-group" style="width:100%"  >
              ...
              <select class=" form-control" id="certification" multiple="multiple">
                ...
                @foreach ($jobCertifications as $jobCertification)
                   <option value="{{$jobCertification->id}}">{{$jobCertification->name}}</option>
                @endforeach
              </select>
            </div>
          </div>
...
$( ".filter-percentage" ).slider({
 ...
 change: function( event, ui ) {
       ...
       $('#precision-percentage').html(ui.value + '%');
          ...
          <div class="row">
            <button type="button" id="filter-btn" class="btn btn-warning btn-raised btn-animate btn-animate-side"  >
