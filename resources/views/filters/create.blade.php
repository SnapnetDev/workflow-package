<!-- Modal -->
<form method="POST" action="{{ route('process.action',['filter-create']) }}">
    @csrf
    <div id="filter-create" class="modal fade" role="dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            {{--<textarea  placeholder="Keywords" type="text" class="form-control" name="keywords" value="" required autofocus required=""></textarea>--}}
