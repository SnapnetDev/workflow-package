                    <div style="border-bottom: 1px solid #000;" id="job-recruitment">
                        <b style="color: #000;">Required Recruitment Levels</b>
                    </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <table class="table">
                            ...
                            @foreach ($job->jobRecruitmentTypes as $jobRecruitmentType)
                             <tr>
                                 <td>{{$jobRecruitmentType->recruitmentType->name}}</td>
                                 <td>
            <div class="dropdown show pull-right">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" x-placement="bottom-start" style="position: absolute; transform: translate3d(-5px, 38px, 0px); top: 0px; left: 0px; will-change: transform;">
                     ...
                     <form method="post" action="{{ route('jobrecruitmenttype.destroy',$jobRecruitmentType->id) }}">
                     ...
                     <button class="dropdown-item btn btn-danger btn-sm" data-backdrop="false"  data-toggle="modal" data-target="#approveReject" >Remove</button>
                        ...
                        <form method="post" action="{{ route('jobrecruitmenttype.store') }}">
                            @csrf
                            @method('POST')
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="jb_recruitment_type_id" style="width: 70%;display: inline-block;"  required>
                                    <option value="">--Select Recruitment Level--</option>
                                    @foreach ($jb_recruitment_type_ids as $recruitmentType)
