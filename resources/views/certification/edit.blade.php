...
<div class="col-md-12" align="right">
    <a href="{{ route('certification.index') }}" class="btn btn-primary btn-sm" style="margin-bottom: 11px;">Back</a>
</div>


                    <form method="POST" action="{{ route('certification.update',$data->id) }}">
                        @csrf
                        @method('PATCH')
